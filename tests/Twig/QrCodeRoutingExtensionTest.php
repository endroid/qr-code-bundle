...
class QrCodeRoutingExtensionTest extends TestCase
{
    public function testQrCodeUrlFunction()
    {
        ...
        $urlGenerator
            ->generate('qr_code_generate', ['extension' => 'png', 'text' => 'Foobar'], UrlGeneratorInterface::ABSOLUTE_URL)
    ...
    public function testQrCodePathFunction()
    {
        ...
        $urlGenerator
            ->generate('qr_code_generate', ['extension' => 'png', 'text' => 'Foobar'], UrlGeneratorInterface::ABSOLUTE_PATH)
    ...
    public function testGetQrCodeReferenceDifferentImplementation()
    {
        ...
        $urlGenerator
            ->generate('qr_code_generate', ['text' => 'Foobar'], UrlGeneratorInterface::ABSOLUTE_PATH)
            ->willReturn('/some-qr-code-path');
